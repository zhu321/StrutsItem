	...
	function getmultipleanswer(){
		...
		$(function(){
			...
			$("#jiaojuan").click(function(){
				...
				clearInterval(stop);//注意计时结束，要让它暂停
				...
				$.ajax({
					//请求地址
					url:'ajaxUsersAnswer_ajaxScore', //逗号分割
					data:{singleanswer:$("#singleanswer").val(),multipleanswer:$("#multipleanswer").val(),singlegrade:$("#singlegrade").val(),multiplegrade:$("#multiplegrade").val()},
					...
					success:function(data){
						...
						$("#fullpage2").show();
						//或 $("#myscorediv").css('display','display'); 
						$("#myscorediv").show();
						$(".myscore").html(data);
					}
...
<div>
	<img id="waitimg" width="99" height="99" src="/mywebtraining/images/wait.gif"/> <!-- 点击交卷 -->
</div>
...
<div id="myscorediv">
	<h3>本次考试成绩为:<span class="myscore"></span></h3>
	<br/><br/>
	<input type="button" value="确定" id="show"/>
</div>
...
<table width="779" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="/mywebtraining/images/kstop.jpg" width="779" height="140" /></td>
  </tr>
  
  <tr> <!-- xxxxx -->
    <td align="left" valign="top" class="body01"><table width="756" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="body02 body03">当前位置：&gt;&gt;模拟考试   <p style="float:right;margin-right:20px" class="hidanswer">我的成绩：<span class="myscore"></span></p></td> 
      </tr>
      <tr>
        <td class="body02 body04">总分：${maintainTest.totalscore }&nbsp;&nbsp;|&nbsp;&nbsp;考试时间[<label id="testtotal">${maintainTest.totaltime }</label>分钟 ] 
         &nbsp; |&nbsp;&nbsp;剩余时间：[<span id="timespan"></span>] (注意：试卷在规定时间到后自动提交) </td>
      </tr>
      <tr>
        <td class="body02 body05">模拟考试</td>
      </tr>
     ...
     <input type="hidden" name="singlegrade" id="singlegrade" value="${maintainTest.single_grade }"/>
     <input type="hidden" name="multiplegrade" id="multiplegrade" value="${maintainTest.multiple_grade }"/>
      ...
      <tr><!-- 开始1 -->
        ...
        <!-- 一道题就是一个table --><!-- ====================循环开始======================== -->
        <c:forEach items="${mysinglelist }" var="choicebank" varStatus="no">
          ...
          <tbody>
            ...
            <tr>
              <td valign="bottom" width="149">
              	<!-- 先将答案隐藏 -->
             	<span class="hidanswer">正确答案：${choicebank.choice_answer }</span>
             	<br/><br/>
         ...
         <p>二、多选题(共${maintainTest.multiple_quantity }道题，每题${maintainTest.multiple_grade }分)</p>
          ...
          <!-- 一道题就是一个table --><!-- ====================循环开始======================== -->
        <c:forEach items="${mymutiplelist }" var="choicebank" varStatus="no">
	...
	var stop = setInterval(function() {
		...
		if(totaltime >= 0){
			...
			$.ajax({
				...
				url : 'ajaxUsersAnswer_ajaxScore', //逗号分割
				data : {
					singleanswer : $("#singleanswer").val(),
					multipleanswer : $("#multipleanswer").val(),
					singlegrade : $("#singlegrade").val(),
					multiplegrade : $("#multiplegrade").val()
				},
