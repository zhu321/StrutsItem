...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <form action="manualCreateTestpaper_createManualtest" method="post"  enctype="multipart/form-data">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="4" background="/mywebtraining/images/ht-body02.jpg" class="body03">手动生成试卷</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="body06">导入试卷：</td>
          <td class="body04"><input type="file" name="choiceupload" /></td>
         </tr>
...
<!-- =============预览试卷=============== -->
<!-- 加一个判断条件 -->
<c:if test="${not empty singlelist }">
...
<table id="test" width="780" style="border:1px solid #ccc;margin:0 auto">
	...
	<tr><td colspan="3">一、单选题（共${maintaintest.single_quantity }题，每题${maintaintest.single_grade }分）</td></tr>
	<!-- 循环集合 -->
	<c:forEach items="${singlelist }" var="single" varStatus="no">
	...
	<tr><td colspan="3">二、多选题（共${maintaintest.multiple_quantity }题，每题${maintaintest.multiple_grade }分）</td></tr>
	<!-- 循环集合 -->
	<c:forEach items="${mutiplelist }" var="mutiple" varStatus="no">
		<tr height="12"></tr><!-- 题目与题目之间空一行 -->
		<tr>
			<td width="2%"></td><!-- 空白列 -->
