...
<frameset rows="17%,*,4%" name="firFrame">
	<frameset cols="100%,*">
		<frame name="topFrame" src="utop.jsp" scrolling="no"  framespacing="0"   frameborder="0"  />
	</frameset>
	<frameset name="fs" cols="220,8,*">

		<frame name="sidebarFrame" src="usidebar.jsp" scrolling="auto"  noresize framespacing="0"   frameborder="0"  />
